 ...
 */
export function getCompetitionColorClasses(color?: CompetitionColor | string): string {
 ...
 */
export function getEventsForDay(events: CalendarCompetition[], day: Date): CalendarCompetition[] {
  return events
    .filter((event) => {
      const eventStart = new Date(event.start);
 ...
 */
export function sortEvents(events: CalendarCompetition[]): CalendarCompetition[] {
