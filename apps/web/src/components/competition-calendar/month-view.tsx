          ...
          {weeks.map((week, weekIndex) => (
            ...
            >
              {week.map((day, dayIndex) => {
                ...
                return (
                  <div
                    className="group border-border/70 border-r border-b last:border-r-0 data-outside-cell:bg-muted/25 data-today:bg-background-primary data-outside-cell:text-muted-foreground/70"
                        ...
                        {hasMore && (
                          <Popover modal>
                            <PopoverTrigger
                              render={
                                <button
                                  className="mt-(--event-gap) flex h-(--event-height) w-full select-none items-center overflow-hidden px-1 text-left text-[10px] text-muted-foreground outline-none transition hover:bg-muted/50 hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 sm:px-2 sm:text-xs"
