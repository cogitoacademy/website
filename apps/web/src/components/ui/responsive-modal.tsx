  ...
  "bg-background fixed z-50 grid gap-4 p-6 shadow-lg data-open:animate-in data-closed:animate-out duration-300 outline-none ring-foreground/10 ring-1",
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 border-t data-closed:slide-out-to-bottom data-open:slide-in-from-bottom md:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:max-w-fit sm:w-full sm:rounded-lg sm:border sm:data-closed:zoom-out-95 sm:data-open:zoom-in-95 sm:data-closed:slide-out-to-bottom-0 sm:data-open:slide-in-from-bottom-0",
