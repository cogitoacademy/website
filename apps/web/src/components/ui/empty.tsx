  ...
  'mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        icon: "bg-muted text-foreground flex size-8 lg:size-12 shrink-0 items-center justify-center rounded-lg [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='size-'])]:lg:size-8",
      },
    },
    defaultVariants: {
      variant: 'default',
