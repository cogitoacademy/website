...
export default function Footer() {
  ...
  return (
    ...
    >
      {/* Curved top section */}
      {isContactPage ? (
        <div className="absolute top-0 left-0 h-60 w-full -translate-y-full z-1 bg-background-primary [clip-path:polygon(0%_0%,0%_100%,100%_100%,100%_0%,100%_20%,50%_100%,0%_20%)]" />
      ) : (
        <svg
