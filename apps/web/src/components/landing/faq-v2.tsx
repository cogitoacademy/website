    ...
    <>
      ...
      <section className="bg-background-primary">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-y-7.5 px-4 py-20">
          <div className="flex flex-col items-center justify-center space-y-2 *:text-center *:max-w-[335px] *:min-[580px]:max-w-none">
            <Badge variant={"headline-cream"}>
              <SealQuestionIcon className="size-5" /> <span>FAQ</span>
            </Badge>
            <h3 className="font-bold text-2xl lg:text-3xl text-pretty text-neutral-1000 mx-auto lg:max-w-none">
            ...
            <p className="mx-auto max-w-3xl font-medium text-xs md:text-sm xl:text-base text-neutral-1000 md:max-w-none">
              Kami juga siap membantu mendiskusikan rencana prestasimu secara mendalam.
            </p>
          </div>
