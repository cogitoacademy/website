...
export default function Cta() {
  return (
    <section className="relative bg-primary-100 py-20">
      {/*<Container>*/}
      <div className="relative z-1 overflow-visible rounded-3xl bg-neutral-100 max-w-7xl mx-auto p-10 h-[383px]">
        {/* Left Content */}
        <div className="flex flex-col justify-between items-start h-full">
          <div>
            <h2 className="font-bold text-3xl text-gray-900 md:text-5xl leading-tight">
              Temukan Potensi <br />
