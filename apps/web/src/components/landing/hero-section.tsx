    ...
    <section className="relative">
      ...
      <Container className="relative z-1 flex-col items-center pt-28 pb-0 sm:pt-36 md:pt-42 lg:pt-50 max-w-7xl">
        ...
        <section className="grid w-full grid-cols-1 gap-5 md:mt-0 md:grid-cols-3 md:gap-4 -mb-100 md:mb-0">
          ...
          />
          <ClassCard
            className="order-2 min-h-90 bg-tertiary-yellow-400 md:order-1 md:-translate-y-10 -translate-y-70"
          ...
          />
          <ClassCard
            className="order-3 min-h-84 bg-tertiary-pink-300 md:order-3 md:-translate-y-10 -translate-y-100"
