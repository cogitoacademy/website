      ...
      <Container className="relative z-1 flex-col items-center pt-50 pb-0">
        <section className="flex flex-col items-center justify-center">
          <div className="mb-2 rounded-[12px] bg-background-primary px-2.5 py-2 leading-none">
            Didukung oleh <span className="font-bold text-secondary-600">200+</span> prestasi tutor
            di <span className="font-bold text-secondary-600">9</span> bidang keilmuan
          </div>

          {/* Headline */}
          <div className="*:text-center">
            <div className="font-bold text-5xl text-neutral-1000">Mulai Perjalananmu Menjadi</div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3">
          ...
          <ClassCard className="bg-tertiary-blue-500" />
