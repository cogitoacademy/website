    ...
    <>
      ...
      <Container className="relative z-1 flex-col items-center pt-50 pb-0">
        <section className="flex flex-col items-center justify-center">
          <div className="rounded-[12px] bg-background-primary px-2.5 py-2 leading-none mb-2">
            Didukung oleh{" "}
            <span className="text-secondary-600 font-bold">200+</span> prestasi
            tutor di <span className="text-secondary-600 font-bold">9</span>{" "}
            bidang keilmuan
          </div>
          ...
          {/* Subtitle */}
          <p className="max-w-md text-center text-sm text-neutral-1000">
