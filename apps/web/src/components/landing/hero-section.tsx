	...
	const cards = [
		{
			...
			tags: [
				t("hero.classCards.regular.tags.0"),
				t("hero.classCards.regular.tags.1"),
			],
		},
		{
			...
			tags: [
				t("hero.classCards.intensive.tags.0"),
				t("hero.classCards.intensive.tags.1"),
			],
		},
		{
		...
		<section className="relative">
			...
			<Container className="relative z-1 max-w-7xl flex-col items-center pt-28 pb-0 sm:pt-36 md:pt-42 lg:pt-50">
				...
				<section className="-mb-100 grid w-full grid-cols-1 gap-5 md:mt-0 md:mb-0 md:grid-cols-3 md:gap-4">
					...
					/>
					<ClassCard
						className="order-2 min-h-90 -translate-y-70 bg-tertiary-yellow-400 md:order-1 md:-translate-y-10"
					...
					/>
					<ClassCard
						className="order-3 min-h-84 -translate-y-100 bg-tertiary-pink-300 md:order-3 md:-translate-y-10"
