...
export default function StackingPrograms(): JSX.Element {
  ...
  return (
    <div ref={container} className="sticky top-0 flex h-screen items-center justify-center">
      <motion.div
        ...
        className={
          "relative -top-[25%] flex h-[450px] w-[70%] origin-top flex-col rounded-md p-2 sm:p-4 lg:p-10"
        }
      >
        ...
        <div className={"mt-5 flex h-full gap-10"}>
          <div className={"relative top-[10%] w-[40%]"}>
            ...
            <span className="flex items-center gap-2 pt-2">
              <a href={"#"} target="_blank" className="cursor-pointer underline" rel="noopener">
                See more
              </a>
              <svg
                width="22"
