...
export default function NotFound() {
  ...
  return (
    <Empty className="min-h-screen px-4 py-16">
      <EmptyHeader>
        <EmptyMedia variant="icon" className="size-12 bg-neutral-300 text-black">
        ...
        <EmptyDescription className="text-sm md:text-base">{t('description')}</EmptyDescription>
      </EmptyHeader>

      <EmptyContent className="mt-2">
        <Link href="/" className={cn(buttonVariants({ size: 'md', variant: 'gray' }))}>
          {t('button')}
        </Link>
      </EmptyContent>
    </Empty>
